//
//  OverheadPressViewController.swift
//  Power Lifting App
//
...
class OverheadPressViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "OPWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "OPGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "OPWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "OPGoal") as? String
