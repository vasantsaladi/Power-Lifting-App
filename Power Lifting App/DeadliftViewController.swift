...
class DeadliftViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "DWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "DGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "DWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "DGoal") as? String
