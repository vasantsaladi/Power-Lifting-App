//
//  WeightedDipsViewController.swift
//  Power Lifting App
//
...
class WeightedDipsViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "WDWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "WDGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "WDWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "WDGoal") as? String
