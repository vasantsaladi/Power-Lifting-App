...
class BackSquatViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "BSWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "BSGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "BSWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "BSGoal") as? String
