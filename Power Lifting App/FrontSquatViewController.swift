...
class FrontSquatViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "FSWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "FSGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "FSWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "FSGoal") as? String
