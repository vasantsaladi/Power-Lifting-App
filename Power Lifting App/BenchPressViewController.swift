...
class BenchPressViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "BPWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "BPGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "BPWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "BPGoal") as? String
