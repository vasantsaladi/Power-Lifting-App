//
//  WeightedPullUpsViewController.swift
//  Power Lifting App
//
...
class WeightedPullUpsViewController: UIViewController {
    ...
    @IBAction func saveSession(_ sender: Any) {
        ...
        UserDefaults.standard.set(setThreeWeightTextField.text, forKey: "WPWeight")
        
        UserDefaults.standard.set(GoalLabel.text, forKey: "WPGoal")
    ...
    @IBAction func LastSession(_ sender: Any) {
        ...
        LastLabel.text = UserDefaults.standard.object(forKey: "WPWeight") as? String
        
        GoalLabel.text = UserDefaults.standard.object(forKey: "WPGoal") as? String
